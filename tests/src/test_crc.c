...
{
  uint8_t data[] = { 0x00 };
  uint16_t crc = fusain_crc16(data, 0);
...
ZTEST(fusain_crc, test_crc_determinism)
{
  ...
  uint16_t crc1 = fusain_crc16(data, sizeof(data));
  uint16_t crc2 = fusain_crc16(data, sizeof(data));
